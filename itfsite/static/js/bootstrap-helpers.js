...
function show_modal_confirm(title, question, verb, yes_callback, cancel_callback) {
  ...
  if (typeof verb == 'string') {
    ...
    $('#global_modal .btn-danger').toggle(typeof verb[0] == 'string').text(verb[0]);
  }
...
function ajax_with_indicator(options) {
  setTimeout("if (ajax_num_executing_requests > 0) $('#ajax_loading_indicator').fadeIn()", options.indicator_delay || 100);
